...
tags: [T1497_001, techniques, Defense_Evasion,_Discovery]
---

## Virtualization_Sandbox Evasion- System Checks
...
FROM "Detection Rules" AND #T1497_001
```
...
TABLE without id
filename AS "Name"
FROM "Testing Runbooks" AND #T1497_001
```
