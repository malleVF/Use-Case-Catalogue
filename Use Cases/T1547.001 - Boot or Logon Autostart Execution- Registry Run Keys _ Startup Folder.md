...
platforms: Windows
tags: [T1547_001, techniques, Persistence,_Privilege_Escalation]
---

## Boot or Logon Autostart Execution- Registry Run Keys _ Startup Folder
...
FROM "Detection Rules" AND #T1547_001
```
...
TABLE without id
filename AS "Name"
FROM "Testing Runbooks" AND #T1547_001
```
